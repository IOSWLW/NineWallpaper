...
+ (void)requestPhotosWithParams:(NSString *)params callback:(void(^)(WLWImagePhoto *photo,NSError *error))block {
    NSString *path = [NSString stringWithFormat:@"https://pixabay.com/api/?key=5950348-3db6713241de0eed1bacdfb1b&lang=zh&q=wallpaper&min_with=375&min_height=1000%@",params];
